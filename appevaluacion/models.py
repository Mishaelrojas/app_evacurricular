...
class Evaluador(models.Model):
    ...
    codigo_evaluador = models.CharField(max_length=10, unique=True, editable=False) 
...
class DetalleEvaluacion(models.Model):
    ...
    puntaje_promedioP = models.DecimalField(max_digits=5, decimal_places=2, validators=[MinValueValidator(6.00), MaxValueValidator(12.00)], null=False, default=6.00)
    puntaje_cursosEva = models.DecimalField(max_digits=5,decimal_places=2, validators=[MinValueValidator(0.00), MaxValueValidator(4.00)] , null=False, default=0)
    puntaje_partCientifica = models.DecimalField(max_digits=5,decimal_places=2, validators=[MinValueValidator(0.00), MaxValueValidator(4.00)], null=False, default=0)
    puntaje_docenciaUni = models.DecimalField(max_digits=5,decimal_places=2, validators=[MinValueValidator(0.50), MaxValueValidator(3.00)], null=False, default=0.50)
    puntaje_idiomaExt = models.DecimalField(max_digits=5,decimal_places=2, validators=[MinValueValidator(0.50), MaxValueValidator(1.00)], null=False, default=0.50)
    puntaje_capacitacion = models.DecimalField(max_digits=5,decimal_places=2, validators=[MaxValueValidator(24.00)], null=False, default=0) # Primer Subtotal
    puntaje_libroInscritos = models.DecimalField(max_digits=5,decimal_places=2, validators=[MinValueValidator(0.00), MaxValueValidator(2.00)], null=False, default=0)
    puntaje_publicaciones = models.DecimalField(max_digits=5,decimal_places=2, validators=[MinValueValidator(0.00), MaxValueValidator(3.00)], null=False, default=0)
    puntaje_proyInvestig = models.DecimalField(max_digits=5,decimal_places=2, validators=[MinValueValidator(0.00)], null=False, default=0)
    puntaje_asesoriaProy = models.DecimalField(max_digits=5,decimal_places=2, validators=[MinValueValidator(0.00)], null=False, default=0)
    puntaje_produccionCien = models.DecimalField(max_digits=5,decimal_places=2, validators=[MaxValueValidator(11.00)], null=False, default=0)  # Segundo Subtotal
    puntajeFinal = models.DecimalField(max_digits=5,decimal_places=2, validators=[MaxValueValidator(35.00)], null=False, default=0) # Primer Subtotal +  Segundo Subtotal
